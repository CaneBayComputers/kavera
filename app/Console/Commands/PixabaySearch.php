...
class PixabaySearch extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:pixabay-search {query* : Search terms} {--image_type=photo} {--orientation=} {--order=popular} {--safesearch=1} {--per_page=20} {--page=1} {--category=}';
